...
- Board preview text should stay stable during transient agent states: suppress `Working`, `Thinking`, `Messages`, prompt templates, and status-only redraws, and keep showing the previous real answer until a new answer block appears.
