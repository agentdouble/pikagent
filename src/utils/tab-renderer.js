 ...
 * TabManager instance.
 *
 * @typedef {{ activeTabId: string|null, tabs: Map<string, import('./tab-constants.js').WorkspaceTab>, switchTo: (id: string) => void, closeTab: (id: string) => void, renameTab: (id: string, nameEl: HTMLElement) => void, setTabColorGroup: (id: string, colorGroupId: string|null) => void, toggleNoShortcut: (id: string) => void, dragDeps: import('./tab-drag.js').TabDragDeps }} TabElementDeps
 */
 ...
 * @param {string} id
 * @param {import('./tab-constants.js').WorkspaceTab} tab
 */
