 ...
 *
 * @typedef {{ workspaceContainer: HTMLElement, getActiveTabId: () => string|null, getActiveTab: () => import('./tab-constants.js').WorkspaceTab|null, scheduleAutoSave: () => void }} RenderWorkspaceDeps
 *
